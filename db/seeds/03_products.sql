...
(5, 'Lighthouse Labs Bootcamp', 'The goal of our Web Development Bootcamp is to transform you into a professional developer. You''ll come to understand coding logic using popular languages and frameworks like JavaScript & Ruby on Rails, while learning how to think like a programmer by building software from the ground up. Bootcamp will provide you with mentorship, data-driven curriculum, and a top notch learning environment that will launch you into your first Junior Developer role.', 450000, 7, 'https://s3.amazonaws.com/f6s-public/profiles/673293_original.jpg'),
...
(1, 'Samsung 49” CHG90', '144hz 3840x1080 Samsung 49” FreeSync monitor', 130000, 1, 'https://i.imgur.com/FDzoEPr.jpg'),
(3, 'MacBook Pro 13inch 2015 128gb perfect condition', '2015 MacBook Pro 13 inches 128gb in perfect condition running the latest software. Screen protector on. Always had a case', 85000, 1, 'https://i.imgur.com/NGJjoTA.jpg'),
(1, 'Carrera Slot car track', 'Over 23 feet of track. Hardly been used. White car not working properly but can easily be fixed with part from hobby store', 15000, 7, 'https://i.imgur.com/KAdA9Av.jpg'),
(2, 'Vinage wooden biplane', 'Handcrafted to perfection, this wood model is a perfect item for your home, business, or hobby room. Ideal for the aviation collector or the kids rooms. Perfect to add to your collection or to give as that special gift to an aviation enthusiast.', 17500, 7, 'https://i.imgur.com/buxrswz.jpg'),
(3, 'Nintendo 64 Games', 'Army man sarges Hero’s 15$ All star tennis 99 20$ 007 the world is not enough 20$ Pokémon stadium SOLD Pokémon snap SOLD Gameshark version 3.2 30$', 2500, 1, 'https://i.imgur.com/v0dU8zI.jpg'),
